...
<head>
	...
	<link type="text/css" rel="stylesheet">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:stylesheet']/@href"/>
		</xsl:attribute>
	</link>
	<link rel="apple-touch-icon" sizes="180x180">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:favicon-180']/@href"/>
		</xsl:attribute>
	</link>
	<link rel="icon" sizes="96x96">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:favicon-96']/@href"/>
		</xsl:attribute>
	</link>
	<link rel="icon" sizes="48x48">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:favicon-48']/@href"/>
		</xsl:attribute>
	</link>
	<link rel="icon" sizes="32x32">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:favicon-32']/@href"/>
		</xsl:attribute>
	</link>
	<link rel="icon" sizes="16x16">
		<xsl:attribute name="href">
			<xsl:value-of select="sitemap:sitemapindex/*[name()='blush:favicon-16']/@href"/>
		</xsl:attribute>
	</link>
</head>
...
<div class="sitemap sm:container">
	...
	<main class="sitemap__sitemapindex layout-2xl">
